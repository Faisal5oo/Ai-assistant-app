...
export function toClientDashboard(doc) {
  ...
  const flowSession = plain.activeFlowSession;
  ...
  return {
    ...
    ...(timeBlockRunway?.date != null
      ...
      : {}),
    ...(flowSession?.primaryTaskId
      ? {
          activeFlowSession: {
            primaryTaskId: flowSession.primaryTaskId,
            primaryTaskTitle: flowSession.primaryTaskTitle,
            targetTaskIds: flowSession.targetTaskIds ?? [],
            runwayQueue: flowSession.runwayQueue ?? [],
            durationMinutes: flowSession.durationMinutes,
            startedAt: flowSession.startedAt,
            updatedAt: toUpdatedAt(flowSession.updatedAt),
          },
        }
      : {}),
  };
